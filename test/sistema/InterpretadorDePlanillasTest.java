...
public class InterpretadorDePlanillasTest {
	...
	public void planillaSemiValida1() throws ArchivoException {
		...
		listadoDeMaterias.put(3, new Materia(3, "Cuestiones de Sociología, Economía y Política", 2, "1"));
		listadoDeMaterias.put(592, new Materia(592, "Introducción a la Problemática del Mundo Contemporáneo", 1, "1"));
		listadoDeMaterias.put(1265, new Materia(1265, "Análisis Matemático I", 1, "1"));
		listadoDeMaterias.put(1269, new Materia(1269, "Física II", 2, "2"));
		listadoDeMaterias.put(1240, new Materia(1240, "Algoritmos y Programación III", 2, "2"));
		listadoDeMaterias.put(1242, new Materia(1242, "Matemáticas Especiales", 2, "2"));
		listadoDeMaterias.put(1270, new Materia(1270, "Física III", 3, "1"));
	...
	public void planillaSemiValida2() throws ArchivoException, MateriaInvalidaException {
		...
		HashMap<Integer, Materia> listadoDeMaterias = new HashMap<>();
		listadoDeMaterias.put(3, new Materia(3, "Cuestiones de Sociología, Economía y Política", 2, "1"));
		listadoDeMaterias.put(15, new Materia(15, "Análisis Matemático I", 1, "1"));
